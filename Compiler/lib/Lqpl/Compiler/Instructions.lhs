\begin{code}
module Lqpl.Compiler.Instructions where
...
import Lqpl.Compiler.CompSupport(merge, enumerateName)
import Lqpl.Compiler.GenerationErrors
import Lqpl.Compiler.InstructionNames
