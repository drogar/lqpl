require 'left_origin_text'

describe Lqpl::Drawing::LeftOriginText do
  let(:draw_ext) { DrawingExtensions.new }
  subject { Lqpl::Drawing::LeftOriginText.new(graphics_context: draw_ext.gc) }

  describe 'get_string_size' do
    it 'returns a siae for an regulaer string "ab" w=15, h> 14' do
  ...
  describe 'draw_sized_text_at_point' do
    it 'should darken a pixel to the left of the midpoint with :left' do
      ...
      check_raster_point_is_grey(rstr, 52, 49)
    end
  end
end
