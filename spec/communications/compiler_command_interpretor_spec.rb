  ...
  context 'converse' do
    ...
    describe "failure" do
      ...
      context 'helpers' do
        ...
        specify{subject.warning('w'); expect(subject.failure_message).to eql('Warning: w')}
        specify{subject.compile_fail('w'); expect(subject.failure_message).to eql('Compile Failure: w')}
        specify{subject.illegal_input('w'); expect(subject.failure_message).to eql('Illegal Input: w')}
      end
    end
    describe "qpo" do
