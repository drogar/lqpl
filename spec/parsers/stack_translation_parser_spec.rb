...
describe StackTranslationParser do
    ...
    it "should create a three element list with all map items when input a 3 level translation" do
      ...
      expect(stp.parsed_value).to eq([{:p => 1},{:p => 2},{:rex => 27,:p => 3}])
    end
  end
end
