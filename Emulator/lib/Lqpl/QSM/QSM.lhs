...
\begin{code}
module Lqpl.QSM.QSM (
                module Lqpl.QSM.Transformations,
                module Lqpl.QSM.BasicData,
                module Lqpl.Data.ClassComp,
                module Lqpl.Data.Stream,
                module Lqpl.QSM.Components.Instructions,
                module Lqpl.QSM.Components.Dump,
...
qapply' i tr addr cs cq  =
    case (uopToSpecial tr) of
       ...
       Nothing         ->
           let  (topn, cs')     = List.splitAt i $  Lqpl.Data.Stack.toList cs
                ...
                cq'             = Ctrl ctype $ restore $ trans qs'
           in (Lqpl.Data.Stack.fromList cs', cq')
