\begin{code}
{-# LANGUAGE BlockArguments,FlexibleInstances,TypeSynonymInstances,MultiParamTypeClasses,Rank2Types,ExistentialQuantification #-}
module Lqpl.Compiler.ParseLexMonad where
